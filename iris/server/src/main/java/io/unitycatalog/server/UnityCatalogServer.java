...
import io.unitycatalog.server.service.AssetApiService;
...
public class UnityCatalogServer {
  ...
  private void addApiServices(
    ...
    AssetApiService assetApiService = new AssetApiService();
    ...
    armeriaServerBuilder
        ...
        .annotatedService(BASE_PATH + "assets", assetApiService, requestConverterFunction)
        .annotatedService(BASE_PATH + "asset-types", assetApiService, requestConverterFunction);
