...
export interface paths {
    ...
    "/unity-catalog/asset-types": {
         ...
         */
        get: operations["list-asset-types"];
        put?: never;
        /**
         * Create an asset type
         * @description Creates a new asset type.
         */
        post: operations["create-asset-type"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/unity-catalog/asset-types/{full_name}": {
         ...
         */
        delete: operations["delete-asset-type"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/unity-catalog/assets/{full_name}/children": {
         ...
         */
        get: operations["list-child-assets"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        AssetPropertyDef: {
            /** @description The name of the asset property */
            name: string;
            /** @description The data type of the property (e.g., DOUBLE, STRING, INTEGER) */
            data_type: string;
        ...
        AssetTypeInfo: {
            /** @description The name of the catalog where the asset type is */
            catalog_name: string;
            /** @description The name of the schema where the asset type is */
            schema_name: string;
            /** @description The name of the asset type */
            name: string;
            /** @description Full name of the asset type (catalog.schema.name) */
            full_name: string;
            /** @description The comment attached to the asset type */
            comment?: string;
            /** @description List of property definitions for this asset type */
            properties?: components["schemas"]["AssetPropertyDef"][];
            /**
             * Format: int64
             * @description Time at which this asset type was created, in epoch milliseconds
             */
            created_at?: number;
            /** @description The identifier of the user who created the asset type */
            created_by?: string;
            /**
             * Format: int64
             * @description Time at which this asset type was last modified, in epoch milliseconds
             */
            updated_at?: number;
            /** @description The identifier of the user who updated the asset type last time */
            updated_by?: string;
            /** @description The identifier of the user who owns the asset type */
            owner?: string;
        };
        CreateAssetType: {
            /** @description The name of the catalog where the asset type will be created */
            catalog_name: string;
            /** @description The name of the schema where the asset type will be created */
            schema_name: string;
            /** @description The name of the asset type */
            name: string;
            /** @description The comment attached to the asset type */
        ...
        AssetInfo: {
            /** @description The name of the catalog where the asset is */
            catalog_name: string;
            /** @description The name of the schema where the asset is */
            schema_name: string;
            /** @description The name of the asset */
            name: string;
            /** @description Full name of the asset (catalog.schema.name) */
            full_name: string;
            /** @description Full name of the asset type this asset belongs to */
            asset_type_full_name: string;
            /** @description Full name of the parent asset (if this is a child asset) */
            parent_asset_full_name?: string;
            /** @description The comment attached to the asset */
            comment?: string;
            /** @description Key-value properties of the asset */
            properties?: {
                [key: string]: string;
            };
            /** @description List of property bindings for this asset */
            property_bindings?: components["schemas"]["AssetPropertyBinding"][];
            /**
             * Format: int64
             * @description Time at which this asset was created, in epoch milliseconds
             */
            created_at?: number;
            /** @description The identifier of the user who created the asset */
            created_by?: string;
            /**
             * Format: int64
             * @description Time at which this asset was last modified, in epoch milliseconds
             */
            updated_at?: number;
            /** @description The identifier of the user who updated the asset last time */
            updated_by?: string;
            /** @description The identifier of the user who owns the asset */
            owner?: string;
        };
        CreateAsset: {
            /** @description The name of the catalog where the asset will be created */
            catalog_name: string;
            /** @description The name of the schema where the asset will be created */
            schema_name: string;
            /** @description The name of the asset */
            name: string;
            /** @description Full name of the asset type this asset belongs to */
        ...
        AssetPropertyBinding: {
            /** @description The name of the property being bound */
            property_name: string;
            /**
             * @description The type of binding
             * @enum {string}
             */
            binding_type: AssetPropertyBindingBinding_type;
            /** @description Full name of the table (for TABLE_COLUMN binding) */
            table_full_name?: string;
            /** @description Column name in the table (for TABLE_COLUMN binding) */
            column_name?: string;
            /** @description Full name of the volume (for VOLUME_FILE binding) */
            volume_full_name?: string;
            /** @description Path to the file in the volume (for VOLUME_FILE binding) */
            file_path?: string;
            /** @description Full name of the function (for FUNCTION_OUTPUT binding) */
            function_full_name?: string;
            /** @description Name of the metric (for METRIC_VALUE binding) */
            metric_name?: string;
        };
        AssetList: {
        ...
        AssetTypeList: {
            ...
            asset_types?: components["schemas"]["AssetTypeInfo"][];
            /** @description Opaque token to retrieve the next page of results */
            next_page_token?: string;
        };
    };
...
export interface operations {
    ...
    "list-asset-types": {
        parameters: {
            query: {
                ...
                schema_name: string;
                /** @description Maximum number of asset types to return */
                max_results?: number;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AssetTypeList"];
                };
            };
        };
    };
    "create-asset-type": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreateAssetType"];
            };
        };
        responses: {
            ...
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["AssetTypeInfo"];
                };
            };
        };
    };
    "get-asset-type": {
        parameters: {
            ...
            header?: never;
            path: {
                /** @description Full name of the asset type */
                full_name: string;
            };
            cookie?: never;
        };
    ...
    "delete-asset-type": {
        ...
        requestBody?: never;
        responses: {
            /** @description The asset type was successfully deleted */
            204: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    "list-assets": {
        parameters: {
            query: {
                ...
                /** @description The name of the schema */
                schema_name: string;
                /** @description Filter by asset type full name */
                asset_type_full_name?: string;
                /** @description Filter by parent asset full name (for children) */
                parent_asset_full_name?: string;
    ...
    "list-child-assets": {
        parameters: {
            query?: {
                /** @description Maximum number of child assets to return */
                max_results?: number;
                /** @description Opaque pagination token to go to next page */
                page_token?: string;
            };
            header?: never;
            path: {
                /** @description Full name of the parent asset */
                full_name: string;
            };
            cookie?: never;
        };
...
export enum AssetPropertyBindingBinding_type {
