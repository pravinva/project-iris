...
// Component to redirect to Assets page
const AssetsRedirect = ({ catalog, schema }: { catalog: string; schema: string }) => {
  useEffect(() => {
    window.location.href = `/assets/${catalog}/${schema}`;
  }, [catalog, schema]);
  return null;
};
...
const SCHEMA_TABS_MAP = {
  ...
  [SchemaTabs.Assets]: AssetsRedirect,
};
