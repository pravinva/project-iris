...
|------------ | ------------- | ------------- | -------------|
| *AssetsApi* | [**createAsset**](Apis/AssetsApi.md#createasset) | **POST** /unity-catalog/assets | Create an asset |
*AssetsApi* | [**createAssetType**](Apis/AssetsApi.md#createassettype) | **POST** /unity-catalog/asset-types | Create an asset type |
*AssetsApi* | [**deleteAsset**](Apis/AssetsApi.md#deleteasset) | **DELETE** /unity-catalog/assets/{full_name} | Delete an asset |
*AssetsApi* | [**deleteAssetType**](Apis/AssetsApi.md#deleteassettype) | **DELETE** /unity-catalog/asset-types/{full_name} | Delete an asset type |
*AssetsApi* | [**getAsset**](Apis/AssetsApi.md#getasset) | **GET** /unity-catalog/assets/{full_name} | Get an asset |
*AssetsApi* | [**getAssetType**](Apis/AssetsApi.md#getassettype) | **GET** /unity-catalog/asset-types/{full_name} | Get an asset type |
*AssetsApi* | [**listAssetTypes**](Apis/AssetsApi.md#listassettypes) | **GET** /unity-catalog/asset-types | List asset types |
*AssetsApi* | [**listAssets**](Apis/AssetsApi.md#listassets) | **GET** /unity-catalog/assets | List assets |
*AssetsApi* | [**listChildAssets**](Apis/AssetsApi.md#listchildassets) | **GET** /unity-catalog/assets/{full_name}/children | List child assets |
...
## Documentation for Models
 ...
 - [AssetPropertyBinding](./Models/AssetPropertyBinding.md)
 - [AssetPropertyDef](./Models/AssetPropertyDef.md)
 ...
 - [CreateAsset](./Models/CreateAsset.md)
 - [CreateAssetType](./Models/CreateAssetType.md)
